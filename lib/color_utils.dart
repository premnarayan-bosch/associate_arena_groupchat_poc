...
class ColorUtils {
  final primaryColor = const Color(0xFFFF6633);
  final primaryColor1 = const Color(0xFF999966);
  final primaryColor2 = const Color(0xFF1AB399);

  // final (0xFFFF6633), Color(0xFFFFB399), Color(0xFFFF33FF),
